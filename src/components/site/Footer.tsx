      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 grid gap-10 md:grid-cols-4">
        <div className="md:col-span-2">
          <div className="flex items-center gap-2">
            <div className="h-8 w-8 rounded-lg bg-[var(--gradient-brand)] grid place-items-center shadow-glow">
              <Sparkles className="h-4 w-4 text-white" />
            </div>
            <span className="text-sm font-semibold">Revendedor digital</span>
          </div>
          <p className="mt-4 text-sm text-muted-foreground max-w-sm">
            Catálogo curado de servicios digitales premium. Entrega rápida,
            soporte humano y garantía en cada producto.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm">
            <li><Link to="/catalogo" className="hover:text-foreground text-muted-foreground">Todos los productos</Link></li>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm">
            <li><Link to="/contacto" className="hover:text-foreground text-muted-foreground">Contacto</Link></li>
